...
-- Create policies for organizations table (drop first to avoid duplicates)
...
-- Create policies for organization_members table (drop first to avoid duplicates)
...
-- Create or replace view for user's organizations
