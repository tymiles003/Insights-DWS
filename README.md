<p align="center">
  <img src="https://www.theaiautomators.com/wp-content/uploads/2025/06/Group-2651.svg" alt="InsightsDWS Logo" width="600"/>
</p>


# InsightsDWS: The Open Source NotebookLM Alternative
...
That's exactly what we've done with **InsightsDWS**. This project is an open-source, self-hostable alternative to NotebookLM. It's designed to be a powerful AI research tool that grounds its responses exclusively in the sources you provide, making it a reliable window into your company's knowledge base.


## About The Project

NotebookLM is one of the most powerful AI research tools available today. However, its closed-source nature limits its potential for customization and private hosting. InsightsDWS was created to bridge this gap.
...
If you're interested in learning how to customize InsightsDWS or build similar applications, join our community, The AI Automators.
...
For a complete demonstration of InsightsDWS, an overview of its architecture, and a step-by-step guide on how to set it up, check out our YouTube video:
...
This guide provides the quickest way to get InsightsDWS up and running so you can test, customize, and experiment.
...
2.  **Create GitHub Account & Repo from Template**
    ...
    * Navigate to the InsightsDWS template repository here: [**github.com/theaiautomators/insights-lm-public**](https://github.com/theaiautomators/insights-lm-public)
...
6.  **Test & Customize**
    * That's it! Your instance of InsightsDWS should now be live.
...
While InsightsDWS is fully open-sourced and Supabase is also open source, it's important to be aware that n8n, which powers much of the backend automation, is not open source in the traditional sense.
...
However, if you plan to use InsightsDWS as part of a commercial SaaS offering—such as reselling access or hosting a public version for multiple clients—you may need to obtain an n8n Enterprise License. We're not lawyers, so we recommend that you review the n8n license and contacting their team if your use case falls into a commercial category.
